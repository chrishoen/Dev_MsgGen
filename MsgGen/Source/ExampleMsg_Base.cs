...
namespace Example
{
    ...
    public class Header : ByteContent
    {
        public Header()
        {
        ...
        //--------------------------------------------------------------------------
        // For Member content messages, the message length cannot be known until
        ...
        public void headerCopyToFrom (ByteBuffer aBuffer,ByteContent aParent)
        {
            //---------------------------------------------------------------------
        ...
        public void headerReCopyToFrom  (ByteBuffer aBuffer,ByteContent aParent)
        {
    ...
    public class MsgAParser : BaseMsgAParser
    {
        ...
        public override bool extractMessageHeaderParms(ByteBuffer aBuffer)
        {
        ...
        //--------------------------------------------------------------------------
        // Create a new message, calls default constructor 

        public override ByteContent createMessage(int aMessageType)
        {
        ...
        public override void processBeforeSend(ByteContent aMsg)
        {
    ...
    public class BaseMsg : ByteContent
    {
        //--------------------------------------------------------------------------
        // The constructor sets default ByteContent information
