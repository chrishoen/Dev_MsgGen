...
namespace MsgGen
{
    ...
    public class OutputFileTMessageCH : OutputFileBase
    {
        //**********************************************************************
        //**********************************************************************
        //**********************************************************************
        ...
        public void writeBlock(BlockData aBlock)
        {
            ...
            mWCH.WriteLine (1, "class {0}  : public Ris::ByteTMessage", aBlock.mName);
        ...
        public void writeMessageCopier()
        {
            ...
            mWCH.WriteSkip ();
            mWCH.WriteLine (1, "class TMessageCopier : public Ris::BaseTMessageCopier");
            mWCH.WriteLine (1, "{");
            mWCH.WriteLine (1, "public:");
            mWCH.WriteSkip ();
            mWCH.WriteBar  (2,1);
            ...
            mWCH.WriteSkip ();
            mWCH.WriteLine (2, "Ris::ByteTMessage* createMessage(int aMsgType);");
            mWCH.WriteSkip ();
            mWCH.WriteBar  (2,1);
            mWCH.WriteLine (2,"// Copy");
            mWCH.WriteSkip ();
            mWCH.WriteLine (2, "void copyToFrom (Ris::ByteBuffer* aBuffer, Ris::ByteTMessage* aMsg);");
            mWCH.WriteSkip ();
            mWCH.WriteBar  (2,1);
            mWCH.WriteLine (2,"// Copy");
            mWCH.WriteSkip ();
